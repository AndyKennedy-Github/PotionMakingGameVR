...
namespace PuppetJump.Objs
{
    public class Grabbable : Touchable
    {
        ...
        private RigidBodyProperties rbProperties = new RigidBodyProperties();   // store the properties of original rigid body
        [ReadOnly]
        public bool hasRigidBodyAtStart = false;                            // does this object have a rigidbody to start
        //public bool grabHidesController = false;            // hides the rendered child objects of the controller (when grabbing an object) if true
